 ...
 */
function pictureSwitching(id,width,height,sliderTime,autoplayIntervalTime) {

    //获取页面元素
    var ipsw=document.getElementById("i-ps-wrapper");
    ...
    function activeBtnColor() {
        ...
        for (var i = 0; i < btns.length; i++) {
            if (i == activeIndex) {
                ...
                ipsw.style.backgroundColor=btns[i].getAttribute("data-color");//父容器样式补充
            } else {
